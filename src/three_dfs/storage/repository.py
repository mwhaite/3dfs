...
class CustomizationRecord:
    """Persisted customization metadata."""
...
class AssetRelationshipRecord:
    """Link a customization session to generated assets."""
...
class AssetRepository:
    ...
    def _row_to_customization(self, row) -> CustomizationRecord:
        payload = self._deserialize_customization_payload(row["parameters"])
        created_at = datetime.fromisoformat(row["created_at"])
        updated_at = datetime.fromisoformat(row["updated_at"])
    ...
    def _row_to_relationship(self, row) -> AssetRelationshipRecord:
        created_at = datetime.fromisoformat(row["created_at"])
        updated_at = datetime.fromisoformat(row["updated_at"])
