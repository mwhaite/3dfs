...
class ParameterSchema:
    ...
    def from_dict(cls, data: Mapping[str, Any]) -> ParameterSchema:
        ...
        parameters = tuple(ParameterDescriptor.from_dict(item) for item in data.get("parameters", []))
...
class CustomizerSession:
    ...
    def from_dict(
        ...
        *,
        ...
        artifacts = tuple(GeneratedArtifact.from_dict(item) for item in data.get("artifacts", []))
